...
class PostDV(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['disqus_rul'] = f"{settings.DISQUS_MY_DOMAIN}{self.object.get_absolute_url()}"
...
class SearchFormView(FormView):
    ...
    def form_valid(self, form):
        ...
        post_list = Post.objects.filter(Q(content__icontains=search_word) | Q(description__icontains=search_word) | Q(title__icontains=search_word)).distinct()
